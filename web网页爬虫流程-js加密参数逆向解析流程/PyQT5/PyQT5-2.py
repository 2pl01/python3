...
class Ui_MainWindow(QWidget):
    ...
    def init_form(self):
        ...
        return  form_layout
    def init_table(self, current_row_coun=0):
        ...
        tab_header = [
            {"field": "number", "text": "序号", 'width': 60},
            {"field": "songname", "text": "歌曲名", 'width': 140},
            {"field": "SingerName", "text": "歌手名", 'width': 130},
            {"field": "AlbumName", "text": "专辑", 'width': 120},
            {"field": "EMixSongID", "text": "歌曲ID", 'width': 120},
            {"field": "url", "text": "歌曲下载URL", 'width': 634},
        ]
        ...
        file_path=os.path.join(BASE_DIR,"DB","new_string_list.json")
